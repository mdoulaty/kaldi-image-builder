...
resource "azurerm_virtual_machine" "myterraformvm" {
    ...
    provisioner "remote-exec" {
        ...
        inline = [
            ...
            "curl -O https://developer.nvidia.com/compute/cuda/10.1/Prod/local_installers/cuda_10.1.168_418.67_linux.run",
            "sudo bash cuda_10.1.168_418.67_linux.run --silent --driver --toolkit --no-man-page",
